...
After looking at it with fresh eyes years on, I decided to see how straight-forwards I could make it, using some more standard Python libraries, and while I do have a certain fondness for the old [Java version](https://github.com/metriccaution/boondoggle/tree/58c38762ba8d021cd4cb49e52ac2c23d3b66849b), I'm impressed with how much cleaner (and more performant) it is...though that might be the benefit of half a decade of coding speaking. I do find that re-implementations benefit more from understanding the problem space much more than they do from "doing it right" the second time.
